...
```{r annotation-code,include=TRUE,eval=FALSE}
...
```{r draw-image}
grid2 <- plot_grid(
  plots$p1 %>% ggdraw() + draw_image(github_path,x=0.95,y=0.95,hjust=1,vjust=1,width=0.12,height=0.12,scale=1),
  plots$p2 %>% ggdraw() + draw_image(github_path,x=0.95,y=0.95,hjust=1,vjust=1,width=0.12,height=0.12,scale=1),
  nrow=1
)
grid2
...
Please scrape responsibly. The end.
